...
class SearchResultTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let localSearchCompletion: MKLocalSearchCompletion = self.addresses[indexPath.row]
            localSearchCompletion.titleHighlightRanges
            searchResultCell.set(mainLabelText: localSearchCompletion.title, range:  localSearchCompletion.titleHighlightRanges)
